<nav class="main-navigation">
	<div class="main-navigation-top-bar">
		<div class="container">
			...
			<?php /* languages_list(); */ ?>
			<div class="main-navigation-bottom-bar-social">
				...
				<a href="https://plus.google.com/+Searchitrecruitment" target="_blank">
					<i class="fa fa-google-plus" aria-hidden="true"></i>
				</a>
			</div>
			<?php /* 
				if ( has_nav_menu( 'one-button' ) ) :
					wp_nav_menu( array(
						'container'      => false,
						'menu_class'     => 'one-button',
						'theme_location' => 'one-button',
						'depth'          => 1,
					) );
				endif; */
			 ?>
	...
	<div class="main-navigation-bottom-bar">
		<div class="container">
			<div class="mobile-menu-btn">
				<p><?php echo __('menu', 'searchit'); ?></p>
				<span class="one"></span>
				<span class="two"></span>
